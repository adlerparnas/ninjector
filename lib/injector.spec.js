...
describe('#DependencyInjector', function() {
	...
	describe('Object creation', function() {
		...
		it('should allow override a dependecy', function() {
			var depOverride = { name: 'new obj' };
			var dep1Obj = i.createInstance('dep1', { MyClass: depOverride });

			chai.expect(dep1Obj.myClass).to.eq(depOverride);
		});
	});
